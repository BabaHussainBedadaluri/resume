    ...
    return (
      <Container ref={ref} m={0} className={classes.container}>
        <Box className={classes.box1}>
          ...
          >
            <Grid item>
              <Typography className={classes.sideHeadingColor} variant="h5">
                Contact
              </Typography>
            </Grid>
            ...
            {contact.map((item, i) => (
              <Grid
                ...
                alignItems="center"
              >
                <Typography style={{ padding: "0 10px" }} variant="body1">
                  {item.icon}
                </Typography>
                {item.val === i ? (
                  <Link
                  ...
                  <Typography
                    style={{ padding: "0 10px", wordBreak: "break-all;" }}
                    variant="body1"
                  >
                    {item.text}
                  </Typography>
        ...
        >
          <Grid item>
            <Typography
              /*contentEditable="true"*/ className={classes.textAlignCenter}
              variant="h2"
            >
              {name}
            </Typography>
          ...
          <Grid item container direction="column">
            ...
            <Grid item>
              {personalProjects.map((edu) => (
                <>
                  <Typography variant="subtitle1" style={{ marginTop: "10px" }}>
                    {edu.title}
                  </Typography>
                  <Typography variant="caption">{edu.info}</Typography>
                  <ul>
                    <li style={{ color: "#434343" }}>
                      <Typography variant="caption">
                        Web Link : {edu.web_link}
                      </Typography>
                    </li>
                  </ul>
                </>
